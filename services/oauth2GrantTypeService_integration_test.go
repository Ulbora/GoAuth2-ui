...
func TestGrantTypeServicei_AddClient(t *testing.T) {
	var c Oauth2Service
	var l lg.Logger
	c.Log = &l
	var p px.GoProxy
...
func TestGrantTypeServicei_AddGrantType(t *testing.T) {
	var c Oauth2Service
	var l lg.Logger
	c.Log = &l
	var p px.GoProxy
...
func TestGrantTypeServicei_GetGrantTypeList(t *testing.T) {
	var c Oauth2Service
	var l lg.Logger
	c.Log = &l
	var p px.GoProxy
...
func TestGrantTypeServicei_DeleteGrantType(t *testing.T) {
	var c Oauth2Service
	var l lg.Logger
	c.Log = &l
	var p px.GoProxy
	...
	c.Host = "http://localhost:3000"
	c.Token = tempToken
	res := c.DeleteGrantType(strconv.FormatInt(gtIDi, 10))
...
func TestGrantTypeServicei_DeleteClient(t *testing.T) {
	var c Oauth2Service
	var l lg.Logger
	c.Log = &l
	var p px.GoProxy
	...
	c.Host = "http://localhost:3000"
	c.Token = tempToken
	res := c.DeleteClient(strconv.FormatInt(CID3i, 10))
